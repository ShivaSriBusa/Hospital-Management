...
int general_rooms(){
	...
	/* Throwing error if file doesn't exists. */
    ...
    /* Checking if there is space in general ward to accomodate a patient . MAX Capacity - 10 */
	...
	if(id > 10){
        ...
        fclose(fptr);  /* Closing file is a good practice */
        return 1;
    }
}
...
int special_rooms(){
	...
	/* Checking if there is space in special ward to accomodate a patient . MAX Capacity - 10 */
