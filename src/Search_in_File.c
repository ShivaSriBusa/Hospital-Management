...
int search_in_file(char* fname, char* str, char* ph) {
    ...
    fstream = fopen("../src/discharged_list.csv", "a");
    printf("\n");
    ...
    // Also update the "patient_record.csv" files "Discharge_status" to "yes".
        ...
        id=id_generate("../src/discharged_list.csv");
        ...
        remove("../src/patient_record.csv");
        rename("../src/temp.csv","../src/patient_record.csv");
    }
    return 0;
}